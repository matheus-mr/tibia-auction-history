...
import com.tibiaauctionhistory.service.auctionfetch.model.PaginatedContentResponse;
...
import com.tibiaauctionhistory.module.utils.DateUtils;
import com.tibiaauctionhistory.module.utils.NumberUtils;
...
public class AuctionFetchServiceImpl implements AuctionFetchService {
    ...
    public AuctionFetchServiceImpl(
            @Value("${tibia-auction-history.seconds-to-wait-between-paginated-content-requests:0}") int SECONDS_TO_WAIT_BETWEEN_PAGINATED_CONTENT_REQUESTS
    ) {
